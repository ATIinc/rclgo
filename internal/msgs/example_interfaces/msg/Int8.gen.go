...
func init() {
	...
	typemap.RegisterMessage("example_interfaces/msg/Int8", Int8TypeSupport)
}

type Int8 struct {
	Data int8 `yaml:"data" json:"data" mapstructure:"data"`// This is an example message of using a primitive datatype, in8.If you want to test with this that's fine, but if you are deployingit into a system you should create a semantically meaningful message type.If you want to embed it in another message, use the primitive data type instead.
}
...
func NewInt8Subscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int8SubscriptionCallback) (*Int8Subscription, error) {
	...
	sub, err := node.NewSubscription(topic_name, Int8TypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func Int8__Sequence_to_C(cSlice *CInt8__Sequence, goSlice []Int8) {
	...
	cSlice.data = (*C.example_interfaces__msg__Int8)(C.malloc(C.sizeof_struct_example_interfaces__msg__Int8 * C.size_t(len(goSlice))))
