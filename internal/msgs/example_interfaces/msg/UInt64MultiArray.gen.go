...
func init() {
	...
	typemap.RegisterMessage("example_interfaces/msg/UInt64MultiArray", UInt64MultiArrayTypeSupport)
}
...
type UInt64MultiArray struct {
	...
	Data []uint64 `yaml:"data" json:"data" mapstructure:"data"`// array of data
}
...
func NewUInt64MultiArrayPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*UInt64MultiArrayPublisher, error) {
	pub, err := node.NewPublisher(topic_name, UInt64MultiArrayTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
func UInt64MultiArray__Sequence_to_C(cSlice *CUInt64MultiArray__Sequence, goSlice []UInt64MultiArray) {
	...
	cSlice.data = (*C.example_interfaces__msg__UInt64MultiArray)(C.malloc(C.sizeof_struct_example_interfaces__msg__UInt64MultiArray * C.size_t(len(goSlice))))
