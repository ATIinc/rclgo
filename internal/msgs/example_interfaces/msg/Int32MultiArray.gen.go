...
func init() {
	...
	typemap.RegisterMessage("example_interfaces/msg/Int32MultiArray", Int32MultiArrayTypeSupport)
}
...
type Int32MultiArray struct {
	...
	Data []int32 `yaml:"data" json:"data" mapstructure:"data"`// array of data
}
...
func NewInt32MultiArrayPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*Int32MultiArrayPublisher, error) {
	pub, err := node.NewPublisher(topic_name, Int32MultiArrayTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
func NewInt32MultiArraySubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int32MultiArraySubscriptionCallback) (*Int32MultiArraySubscription, error) {
	...
	sub, err := node.NewSubscription(topic_name, Int32MultiArrayTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
