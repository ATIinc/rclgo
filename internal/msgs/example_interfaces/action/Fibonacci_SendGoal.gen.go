...
func init() {
	typemap.RegisterService("example_interfaces/Fibonacci_SendGoal", Fibonacci_SendGoalTypeSupport)
	typemap.RegisterService("example_interfaces/action/Fibonacci_SendGoal", Fibonacci_SendGoalTypeSupport)
}
...
func (s _Fibonacci_SendGoalTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__example_interfaces__action__Fibonacci_SendGoal())
}
