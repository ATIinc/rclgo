...
type Fibonacci_Feedback struct {
	Sequence []int32 `yaml:"sequence" json:"sequence" mapstructure:"sequence"`// Feedback
}
...
func Fibonacci_Feedback__Sequence_to_C(cSlice *CFibonacci_Feedback__Sequence, goSlice []Fibonacci_Feedback) {
	...
	cSlice.data = (*C.example_interfaces__action__Fibonacci_Feedback)(C.malloc(C.sizeof_struct_example_interfaces__action__Fibonacci_Feedback * C.size_t(len(goSlice))))
