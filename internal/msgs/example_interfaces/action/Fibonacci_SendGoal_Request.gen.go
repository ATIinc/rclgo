...
func init() {
	typemap.RegisterMessage("example_interfaces/Fibonacci_SendGoal_Request", Fibonacci_SendGoal_RequestTypeSupport)
	typemap.RegisterMessage("example_interfaces/action/Fibonacci_SendGoal_Request", Fibonacci_SendGoal_RequestTypeSupport)
}
...
type Fibonacci_SendGoal_Request struct {
	...
	Goal Fibonacci_Goal `yaml:"goal" json:"goal" mapstructure:"goal"`
}
...
func (t _Fibonacci_SendGoal_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__action__Fibonacci_SendGoal_Request
	return (unsafe.Pointer)(C.example_interfaces__action__Fibonacci_SendGoal_Request__create())
}

func (t _Fibonacci_SendGoal_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.example_interfaces__action__Fibonacci_SendGoal_Request__destroy((*C.example_interfaces__action__Fibonacci_SendGoal_Request)(pointer_to_free))
}
...
func (t _Fibonacci_SendGoal_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem := (*C.example_interfaces__action__Fibonacci_SendGoal_Request)(dst)
...
func (t _Fibonacci_SendGoal_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_SendGoal_Request)
	mem := (*C.example_interfaces__action__Fibonacci_SendGoal_Request)(ros2_message_buffer)
...
func (t _Fibonacci_SendGoal_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__example_interfaces__action__Fibonacci_SendGoal_Request())
}
...
func Fibonacci_SendGoal_Request__Sequence_to_C(cSlice *CFibonacci_SendGoal_Request__Sequence, goSlice []Fibonacci_SendGoal_Request) {
	...
	cSlice.data = (*C.example_interfaces__action__Fibonacci_SendGoal_Request)(C.malloc(C.sizeof_struct_example_interfaces__action__Fibonacci_SendGoal_Request * C.size_t(len(goSlice))))
