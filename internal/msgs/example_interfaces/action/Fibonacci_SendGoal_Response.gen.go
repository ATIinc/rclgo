...
func (t _Fibonacci_SendGoal_ResponseTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__action__Fibonacci_SendGoal_Response
	return (unsafe.Pointer)(C.example_interfaces__action__Fibonacci_SendGoal_Response__create())
}

func (t _Fibonacci_SendGoal_ResponseTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.example_interfaces__action__Fibonacci_SendGoal_Response__destroy((*C.example_interfaces__action__Fibonacci_SendGoal_Response)(pointer_to_free))
}
...
func (t _Fibonacci_SendGoal_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem := (*C.example_interfaces__action__Fibonacci_SendGoal_Response)(dst)
...
func (t _Fibonacci_SendGoal_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_SendGoal_Response)
	mem := (*C.example_interfaces__action__Fibonacci_SendGoal_Response)(ros2_message_buffer)
...
func (t _Fibonacci_SendGoal_ResponseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__example_interfaces__action__Fibonacci_SendGoal_Response())
}
...
func Fibonacci_SendGoal_Response__Sequence_to_C(cSlice *CFibonacci_SendGoal_Response__Sequence, goSlice []Fibonacci_SendGoal_Response) {
	...
	cSlice.data = (*C.example_interfaces__action__Fibonacci_SendGoal_Response)(C.malloc(C.sizeof_struct_example_interfaces__action__Fibonacci_SendGoal_Response * C.size_t(len(goSlice))))
