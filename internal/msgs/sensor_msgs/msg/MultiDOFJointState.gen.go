...
type MultiDOFJointState struct {
	...
	JointNames []string `yaml:"joint_names" json:"joint_names"`
	Transforms []geometry_msgs_msg.Transform `yaml:"transforms" json:"transforms"`
	Twist []geometry_msgs_msg.Twist `yaml:"twist" json:"twist"`
	Wrench []geometry_msgs_msg.Wrench `yaml:"wrench" json:"wrench"`
}
