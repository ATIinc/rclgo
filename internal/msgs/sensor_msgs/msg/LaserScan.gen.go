...
type LaserScan struct {
	...
	Ranges []float32 `yaml:"ranges" json:"ranges"`// range data [m]
	Intensities []float32 `yaml:"intensities" json:"intensities"`// intensity data [device-specific units].  If your. (Note: values < range_min or > range_max should be discarded)
}
