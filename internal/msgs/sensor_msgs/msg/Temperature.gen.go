...
type Temperature struct {
	Header std_msgs_msg.Header `yaml:"header" json:"header"`// timestamp is the time the temperature was measured
	Temperature float64 `yaml:"temperature" json:"temperature"`// Measurement of the Temperature in Degrees Celsius.
