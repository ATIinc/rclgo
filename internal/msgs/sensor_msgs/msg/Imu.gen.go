...
type Imu struct {
	...
	Orientation geometry_msgs_msg.Quaternion `yaml:"orientation" json:"orientation"`
	OrientationCovariance [9]float64 `yaml:"orientation_covariance" json:"orientation_covariance"`// Row major about x, y, z axes
	AngularVelocity geometry_msgs_msg.Vector3 `yaml:"angular_velocity" json:"angular_velocity"`
	AngularVelocityCovariance [9]float64 `yaml:"angular_velocity_covariance" json:"angular_velocity_covariance"`// Row major about x, y, z axes
	LinearAcceleration geometry_msgs_msg.Vector3 `yaml:"linear_acceleration" json:"linear_acceleration"`
	LinearAccelerationCovariance [9]float64 `yaml:"linear_acceleration_covariance" json:"linear_acceleration_covariance"`// Row major x, y z
}
