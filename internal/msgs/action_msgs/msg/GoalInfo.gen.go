...
type GoalInfo struct {
	GoalId unique_identifier_msgs_msg.UUID `yaml:"goal_id" json:"goal_id"`// Goal ID
	Stamp builtin_interfaces_msg.Time `yaml:"stamp" json:"stamp"`// Time when the goal was accepted
}
