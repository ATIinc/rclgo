...
type TransformStamped struct {
	Header std_msgs_msg.Header `yaml:"header" json:"header" mapstructure:"header"`// The frame id in the header is used as the reference frame of this transform.
	ChildFrameId string `yaml:"child_frame_id" json:"child_frame_id" mapstructure:"child_frame_id"`// The frame id of the child frame to which this transform points.
	Transform Transform `yaml:"transform" json:"transform" mapstructure:"transform"`// Translation and rotation in 3-dimensions of child_frame_id from header.frame_id.
}
