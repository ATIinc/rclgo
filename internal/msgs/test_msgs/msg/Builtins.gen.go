...
type Builtins struct {
	DurationValue builtin_interfaces_msg.Duration `yaml:"duration_value" json:"duration_value" mapstructure:"duration_value"`
	TimeValue builtin_interfaces_msg.Time `yaml:"time_value" json:"time_value" mapstructure:"time_value"`
}
