...
type MultiNested struct {
	ArrayOfArrays [3]Arrays `yaml:"array_of_arrays" json:"array_of_arrays" mapstructure:"array_of_arrays"`// Mulitple levels of nested messages
	ArrayOfBoundedSequences [3]BoundedSequences `yaml:"array_of_bounded_sequences" json:"array_of_bounded_sequences" mapstructure:"array_of_bounded_sequences"`
	ArrayOfUnboundedSequences [3]UnboundedSequences `yaml:"array_of_unbounded_sequences" json:"array_of_unbounded_sequences" mapstructure:"array_of_unbounded_sequences"`
	BoundedSequenceOfArrays []Arrays `yaml:"bounded_sequence_of_arrays" json:"bounded_sequence_of_arrays" mapstructure:"bounded_sequence_of_arrays"`
	BoundedSequenceOfBoundedSequences []BoundedSequences `yaml:"bounded_sequence_of_bounded_sequences" json:"bounded_sequence_of_bounded_sequences" mapstructure:"bounded_sequence_of_bounded_sequences"`
	BoundedSequenceOfUnboundedSequences []UnboundedSequences `yaml:"bounded_sequence_of_unbounded_sequences" json:"bounded_sequence_of_unbounded_sequences" mapstructure:"bounded_sequence_of_unbounded_sequences"`
	UnboundedSequenceOfArrays []Arrays `yaml:"unbounded_sequence_of_arrays" json:"unbounded_sequence_of_arrays" mapstructure:"unbounded_sequence_of_arrays"`
	UnboundedSequenceOfBoundedSequences []BoundedSequences `yaml:"unbounded_sequence_of_bounded_sequences" json:"unbounded_sequence_of_bounded_sequences" mapstructure:"unbounded_sequence_of_bounded_sequences"`
	UnboundedSequenceOfUnboundedSequences []UnboundedSequences `yaml:"unbounded_sequence_of_unbounded_sequences" json:"unbounded_sequence_of_unbounded_sequences" mapstructure:"unbounded_sequence_of_unbounded_sequences"`
}
