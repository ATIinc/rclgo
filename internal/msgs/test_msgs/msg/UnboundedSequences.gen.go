...
type UnboundedSequences struct {
	BoolValues []bool `yaml:"bool_values" json:"bool_values" mapstructure:"bool_values"`// Unbounded sequences of different types
	ByteValues []byte `yaml:"byte_values" json:"byte_values" mapstructure:"byte_values"`
	CharValues []byte `yaml:"char_values" json:"char_values" mapstructure:"char_values"`
	Float32Values []float32 `yaml:"float32_values" json:"float32_values" mapstructure:"float32_values"`
	Float64Values []float64 `yaml:"float64_values" json:"float64_values" mapstructure:"float64_values"`
	Int8Values []int8 `yaml:"int8_values" json:"int8_values" mapstructure:"int8_values"`
	Uint8Values []uint8 `yaml:"uint8_values" json:"uint8_values" mapstructure:"uint8_values"`
	Int16Values []int16 `yaml:"int16_values" json:"int16_values" mapstructure:"int16_values"`
	Uint16Values []uint16 `yaml:"uint16_values" json:"uint16_values" mapstructure:"uint16_values"`
	Int32Values []int32 `yaml:"int32_values" json:"int32_values" mapstructure:"int32_values"`
	Uint32Values []uint32 `yaml:"uint32_values" json:"uint32_values" mapstructure:"uint32_values"`
	Int64Values []int64 `yaml:"int64_values" json:"int64_values" mapstructure:"int64_values"`
	Uint64Values []uint64 `yaml:"uint64_values" json:"uint64_values" mapstructure:"uint64_values"`
	StringValues []string `yaml:"string_values" json:"string_values" mapstructure:"string_values"`
	BasicTypesValues []BasicTypes `yaml:"basic_types_values" json:"basic_types_values" mapstructure:"basic_types_values"`
	ConstantsValues []Constants `yaml:"constants_values" json:"constants_values" mapstructure:"constants_values"`
	DefaultsValues []Defaults `yaml:"defaults_values" json:"defaults_values" mapstructure:"defaults_values"`
	BoolValuesDefault []bool `yaml:"bool_values_default" json:"bool_values_default" mapstructure:"bool_values_default"`
	ByteValuesDefault []byte `yaml:"byte_values_default" json:"byte_values_default" mapstructure:"byte_values_default"`
	CharValuesDefault []byte `yaml:"char_values_default" json:"char_values_default" mapstructure:"char_values_default"`
	Float32ValuesDefault []float32 `yaml:"float32_values_default" json:"float32_values_default" mapstructure:"float32_values_default"`
	Float64ValuesDefault []float64 `yaml:"float64_values_default" json:"float64_values_default" mapstructure:"float64_values_default"`
	Int8ValuesDefault []int8 `yaml:"int8_values_default" json:"int8_values_default" mapstructure:"int8_values_default"`
	Uint8ValuesDefault []uint8 `yaml:"uint8_values_default" json:"uint8_values_default" mapstructure:"uint8_values_default"`
	Int16ValuesDefault []int16 `yaml:"int16_values_default" json:"int16_values_default" mapstructure:"int16_values_default"`
	Uint16ValuesDefault []uint16 `yaml:"uint16_values_default" json:"uint16_values_default" mapstructure:"uint16_values_default"`
	Int32ValuesDefault []int32 `yaml:"int32_values_default" json:"int32_values_default" mapstructure:"int32_values_default"`
	Uint32ValuesDefault []uint32 `yaml:"uint32_values_default" json:"uint32_values_default" mapstructure:"uint32_values_default"`
	Int64ValuesDefault []int64 `yaml:"int64_values_default" json:"int64_values_default" mapstructure:"int64_values_default"`
	Uint64ValuesDefault []uint64 `yaml:"uint64_values_default" json:"uint64_values_default" mapstructure:"uint64_values_default"`
	StringValuesDefault []string `yaml:"string_values_default" json:"string_values_default" mapstructure:"string_values_default"`
	AlignmentCheck int32 `yaml:"alignment_check" json:"alignment_check" mapstructure:"alignment_check"`// Regression test: check alignment of basic field after a sequence field is correct
}
