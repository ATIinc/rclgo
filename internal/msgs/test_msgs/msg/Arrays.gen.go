...
type Arrays struct {
	BoolValues [3]bool `yaml:"bool_values" json:"bool_values" mapstructure:"bool_values"`// Arrays of different types
	ByteValues [3]byte `yaml:"byte_values" json:"byte_values" mapstructure:"byte_values"`
	CharValues [3]byte `yaml:"char_values" json:"char_values" mapstructure:"char_values"`
	Float32Values [3]float32 `yaml:"float32_values" json:"float32_values" mapstructure:"float32_values"`
	Float64Values [3]float64 `yaml:"float64_values" json:"float64_values" mapstructure:"float64_values"`
	Int8Values [3]int8 `yaml:"int8_values" json:"int8_values" mapstructure:"int8_values"`
	Uint8Values [3]uint8 `yaml:"uint8_values" json:"uint8_values" mapstructure:"uint8_values"`
	Int16Values [3]int16 `yaml:"int16_values" json:"int16_values" mapstructure:"int16_values"`
	Uint16Values [3]uint16 `yaml:"uint16_values" json:"uint16_values" mapstructure:"uint16_values"`
	Int32Values [3]int32 `yaml:"int32_values" json:"int32_values" mapstructure:"int32_values"`
	Uint32Values [3]uint32 `yaml:"uint32_values" json:"uint32_values" mapstructure:"uint32_values"`
	Int64Values [3]int64 `yaml:"int64_values" json:"int64_values" mapstructure:"int64_values"`
	Uint64Values [3]uint64 `yaml:"uint64_values" json:"uint64_values" mapstructure:"uint64_values"`
	StringValues [3]string `yaml:"string_values" json:"string_values" mapstructure:"string_values"`
	BasicTypesValues [3]BasicTypes `yaml:"basic_types_values" json:"basic_types_values" mapstructure:"basic_types_values"`
	ConstantsValues [3]Constants `yaml:"constants_values" json:"constants_values" mapstructure:"constants_values"`
	DefaultsValues [3]Defaults `yaml:"defaults_values" json:"defaults_values" mapstructure:"defaults_values"`
	BoolValuesDefault [3]bool `yaml:"bool_values_default" json:"bool_values_default" mapstructure:"bool_values_default"`
	ByteValuesDefault [3]byte `yaml:"byte_values_default" json:"byte_values_default" mapstructure:"byte_values_default"`
	CharValuesDefault [3]byte `yaml:"char_values_default" json:"char_values_default" mapstructure:"char_values_default"`
	Float32ValuesDefault [3]float32 `yaml:"float32_values_default" json:"float32_values_default" mapstructure:"float32_values_default"`
	Float64ValuesDefault [3]float64 `yaml:"float64_values_default" json:"float64_values_default" mapstructure:"float64_values_default"`
	Int8ValuesDefault [3]int8 `yaml:"int8_values_default" json:"int8_values_default" mapstructure:"int8_values_default"`
	Uint8ValuesDefault [3]uint8 `yaml:"uint8_values_default" json:"uint8_values_default" mapstructure:"uint8_values_default"`
	Int16ValuesDefault [3]int16 `yaml:"int16_values_default" json:"int16_values_default" mapstructure:"int16_values_default"`
	Uint16ValuesDefault [3]uint16 `yaml:"uint16_values_default" json:"uint16_values_default" mapstructure:"uint16_values_default"`
	Int32ValuesDefault [3]int32 `yaml:"int32_values_default" json:"int32_values_default" mapstructure:"int32_values_default"`
	Uint32ValuesDefault [3]uint32 `yaml:"uint32_values_default" json:"uint32_values_default" mapstructure:"uint32_values_default"`
	Int64ValuesDefault [3]int64 `yaml:"int64_values_default" json:"int64_values_default" mapstructure:"int64_values_default"`
	Uint64ValuesDefault [3]uint64 `yaml:"uint64_values_default" json:"uint64_values_default" mapstructure:"uint64_values_default"`
	StringValuesDefault [3]string `yaml:"string_values_default" json:"string_values_default" mapstructure:"string_values_default"`
	AlignmentCheck int32 `yaml:"alignment_check" json:"alignment_check" mapstructure:"alignment_check"`// Regression test: check alignment of basic field after an array field is correct
}
...
func Arrays__Sequence_to_Go(goSlice *[]Arrays, cSlice CArrays__Sequence) {
	...
	*goSlice = make([]Arrays, cSlice.size)
	src := unsafe.Slice(cSlice.data, cSlice.size)
	for i := range src {
		ArraysTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(&src[i]))
	}
}
func Arrays__Sequence_to_C(cSlice *CArrays__Sequence, goSlice []Arrays) {
	...
	cSlice.data = (*C.test_msgs__msg__Arrays)(C.malloc(C.sizeof_struct_test_msgs__msg__Arrays * C.size_t(len(goSlice))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity
	dst := unsafe.Slice(cSlice.data, cSlice.size)
	for i := range goSlice {
		ArraysTypeSupport.AsCStruct(unsafe.Pointer(&dst[i]), &goSlice[i])
	}
}
