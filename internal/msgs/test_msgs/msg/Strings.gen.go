...
type Strings struct {
	StringValue string `yaml:"string_value" json:"string_value" mapstructure:"string_value"`
	StringValueDefault1 string `yaml:"string_value_default1" json:"string_value_default1" mapstructure:"string_value_default1"`
	StringValueDefault2 string `yaml:"string_value_default2" json:"string_value_default2" mapstructure:"string_value_default2"`
	StringValueDefault3 string `yaml:"string_value_default3" json:"string_value_default3" mapstructure:"string_value_default3"`
	StringValueDefault4 string `yaml:"string_value_default4" json:"string_value_default4" mapstructure:"string_value_default4"`
	StringValueDefault5 string `yaml:"string_value_default5" json:"string_value_default5" mapstructure:"string_value_default5"`
	BoundedStringValue string `yaml:"bounded_string_value" json:"bounded_string_value" mapstructure:"bounded_string_value"`
	BoundedStringValueDefault1 string `yaml:"bounded_string_value_default1" json:"bounded_string_value_default1" mapstructure:"bounded_string_value_default1"`
	BoundedStringValueDefault2 string `yaml:"bounded_string_value_default2" json:"bounded_string_value_default2" mapstructure:"bounded_string_value_default2"`
	BoundedStringValueDefault3 string `yaml:"bounded_string_value_default3" json:"bounded_string_value_default3" mapstructure:"bounded_string_value_default3"`
	BoundedStringValueDefault4 string `yaml:"bounded_string_value_default4" json:"bounded_string_value_default4" mapstructure:"bounded_string_value_default4"`
	BoundedStringValueDefault5 string `yaml:"bounded_string_value_default5" json:"bounded_string_value_default5" mapstructure:"bounded_string_value_default5"`
}
