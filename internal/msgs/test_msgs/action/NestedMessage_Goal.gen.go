...
type NestedMessage_Goal struct {
	NestedFieldNoPkg test_msgs_msg.Builtins `yaml:"nested_field_no_pkg" json:"nested_field_no_pkg" mapstructure:"nested_field_no_pkg"`// goal definition
	NestedField test_msgs_msg.BasicTypes `yaml:"nested_field" json:"nested_field" mapstructure:"nested_field"`
	NestedDifferentPkg builtin_interfaces_msg.Time `yaml:"nested_different_pkg" json:"nested_different_pkg" mapstructure:"nested_different_pkg"`
}
...
func NewNestedMessage_GoalSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback NestedMessage_GoalSubscriptionCallback) (*NestedMessage_GoalSubscription, error) {
	...
	sub, err := node.NewSubscription(topic_name, NestedMessage_GoalTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
