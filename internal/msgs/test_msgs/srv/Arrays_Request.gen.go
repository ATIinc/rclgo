...
type Arrays_Request struct {
	BoolValues [3]bool `yaml:"bool_values" json:"bool_values" mapstructure:"bool_values"`
	...
	BasicTypesValues [3]test_msgs_msg.BasicTypes `yaml:"basic_types_values" json:"basic_types_values" mapstructure:"basic_types_values"`
	ConstantsValues [3]test_msgs_msg.Constants `yaml:"constants_values" json:"constants_values" mapstructure:"constants_values"`
	DefaultsValues [3]test_msgs_msg.Defaults `yaml:"defaults_values" json:"defaults_values" mapstructure:"defaults_values"`
...
func NewArrays_RequestSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback Arrays_RequestSubscriptionCallback) (*Arrays_RequestSubscription, error) {
	...
	sub, err := node.NewSubscription(topic_name, Arrays_RequestTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func Arrays_Request__Sequence_to_Go(goSlice *[]Arrays_Request, cSlice CArrays_Request__Sequence) {
	...
	*goSlice = make([]Arrays_Request, cSlice.size)
	src := unsafe.Slice(cSlice.data, cSlice.size)
	for i := range src {
		Arrays_RequestTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(&src[i]))
	}
}
func Arrays_Request__Sequence_to_C(cSlice *CArrays_Request__Sequence, goSlice []Arrays_Request) {
	...
	for i := range goSlice {
		Arrays_RequestTypeSupport.AsCStruct(unsafe.Pointer(&dst[i]), &goSlice[i])
	}
}
