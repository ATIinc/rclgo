...
type BasicTypes_Response struct {
	BoolValue bool `yaml:"bool_value" json:"bool_value" mapstructure:"bool_value"`
	ByteValue byte `yaml:"byte_value" json:"byte_value" mapstructure:"byte_value"`
	CharValue byte `yaml:"char_value" json:"char_value" mapstructure:"char_value"`
	Float32Value float32 `yaml:"float32_value" json:"float32_value" mapstructure:"float32_value"`
	Float64Value float64 `yaml:"float64_value" json:"float64_value" mapstructure:"float64_value"`
	Int8Value int8 `yaml:"int8_value" json:"int8_value" mapstructure:"int8_value"`
	Uint8Value uint8 `yaml:"uint8_value" json:"uint8_value" mapstructure:"uint8_value"`
	Int16Value int16 `yaml:"int16_value" json:"int16_value" mapstructure:"int16_value"`
	Uint16Value uint16 `yaml:"uint16_value" json:"uint16_value" mapstructure:"uint16_value"`
	Int32Value int32 `yaml:"int32_value" json:"int32_value" mapstructure:"int32_value"`
	Uint32Value uint32 `yaml:"uint32_value" json:"uint32_value" mapstructure:"uint32_value"`
	Int64Value int64 `yaml:"int64_value" json:"int64_value" mapstructure:"int64_value"`
	Uint64Value uint64 `yaml:"uint64_value" json:"uint64_value" mapstructure:"uint64_value"`
